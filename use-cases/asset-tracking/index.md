        ...
        <div id="hero-content">
            ...
            <div class="hero-image">
                <div class="image-wrapper-laptop">
                    <img
                        id="icon-laptop"
                        srcset="/images/asset-tracking/asset-tracking-landing-shapes&photos/Hero_photo_1.webp 1127w"
                        sizes="(max-width: 671px) 360px, (max-width: 999px) 560px, (min-width: 1000px)  1127px, 2254px"
                        src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Hero_photo_1.webp"
                        alt="Laptop with a dashboard"/>
                </div>
                <div class="image-wrapper-phone">
                    <img
                        id="icon-laptop"
                        srcset="/images/asset-tracking/asset-tracking-landing-shapes&photos/Hero_photo_2.webp 1127w"
                        sizes="(max-width: 671px) 360px, (max-width: 999px) 560px, (min-width: 1000px)  1127px, 2254px"
                        src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Hero_photo_2.webp"
    ...
    <div class="what-is-that-block content-wrapper">
        ...
        <div class="right-side-block">
            <img id="what-is-that-dashboard" class="representation-img"
                srcset="/images/asset-tracking/asset-tracking-landing-shapes&photos/Block_2_photo.webp 1127w"
                sizes="(max-width: 671px) 360px, (max-width: 999px) 560px, (min-width: 1000px)  1127px, 2254px"
                src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Block_2_photo.webp"
                alt="Phone with a dashboard"/>
        </div>
    </div>
</section>
    ...
    <div class="features-block content-wrapper">
        ...
        <div class="right-side-block">
            <img id="feature-background"
                srcset="/images/asset-tracking/asset-tracking-landing-shapes&photos/Shape_1.webp 1127w"
                sizes="(max-width: 671px) 360px, (max-width: 999px) 560px, (min-width: 1000px)  1127px, 2254px"
                src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Shape_1.webp"
                alt=""/>
        </div>
    </div>
</section>
    ...
    <div class="features-cards-block content-wrapper">
        ...
        <div class="two-cards-in-row">
            <div class="card equal">
                <div class="card-image">
                    <img id="asset-management-card"
                        src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Geofence_and_location_management.webp"
            ...
            <div class="card equal">
                <div class="card-image">
                    <img id="details-card"
                        src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Detailed_view_of_assets.webp"
...
<section id="other-features">
    <div class="other-features-block content-wrapper">
        ...
        <div class="action">
            <a id="Serv_DevServ_ContactUs2" 
                class="n-button contact-us gtm_button">VIEW ADVANCED FEATURES</a>
        </div>
    </div>
</section>
...
<section id="roadmap">
    <div class="roadmap-block content-wrapper">
        ...
        <div class="actions">
            <a id="Menu_TryItNow" 
                href="/installations/" 
                class="n-button try-demo gtm_button">REGISTRATION</a>
            <button id="Serv_DevServ_ContactUs2" 
                    class="n-button contact-us gtm_button" 
                    onclick="onContactUsClick(1)">CONTACT US</button>
        </div>
    ...
    <div class="connectivity-block content-wrapper">
        <div class="left-side-block">
            <img id="connectivity-dialog" class="representation-img"
                srcset="/images/asset-tracking/asset-tracking-landing-shapes&photos/Connectivity.webp 1127w"
                sizes="(max-width: 671px) 360px, (max-width: 999px) 560px, (min-width: 1000px)  1127px, 2254px"
...
<section id="partners">
    <div class="partners-block content-wrapper">
        ...
        <div class="partners-logo">
            ...
            <div class="logo">
                <img src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Partnrs_2.webp"
                    alt="Seeed logo"/>
            </div>
            <div class="logo">
                <img src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Partnrs_3.webp"
                    alt="Milesight logo"/>
            </div>
            <div class="logo">
                <img src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Partnrs_4.webp"
                    alt="nettra logo"/>
            </div>
            <div class="logo">
                <img src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Partnrs_5.webp"
                    alt="Actility logo"/>
            </div>
            <div class="logo">
                <img src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Partnrs_6.webp"
                    alt="SODAQ logo"/>
            </div>
            <div class="logo">
                <img src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Partnrs_7.webp"
                    alt="DECODE logo"/>
            </div>
            <div class="logo">
                <img src="/images/asset-tracking/asset-tracking-landing-shapes&photos/Partnrs_8.webp"
                    alt="monoZ logo"/>
            </div>
        </div>
